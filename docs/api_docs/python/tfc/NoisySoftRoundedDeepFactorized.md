description: Soft rounded deep factorized distribution + uniform noise.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tfc.NoisySoftRoundedDeepFactorized" />
...
# tfc.NoisySoftRoundedDeepFactorized

<!-- Insert buttons and diff -->

<table class="tfo-notebook-buttons tfo-api nocontent" align="left">
<td>
  <a target="_blank" href="https://github.com/tensorflow/compression/tree/master/tensorflow_compression/python/distributions/round_adapters.py#L273-L283">
...
Inherits From: [`UniformNoiseAdapter`](../tfc/UniformNoiseAdapter.md)

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tfc.NoisySoftRoundedDeepFactorized(
    alpha=5.0, name=&#x27;NoisySoftRoundedDeepFactorized&#x27;, **kwargs
)
</code></pre>
...
<td>
Float or tf.Tensor. Controls smoothness of soft round.
</td>
</tr><tr>
<td>
`name`
