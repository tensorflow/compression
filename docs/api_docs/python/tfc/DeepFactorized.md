description: Fully factorized distribution based on neural network cumulative.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tfc.DeepFactorized" />
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/compression/tree/master/tensorflow_compression/python/distributions/deep_factorized.py#L50-L252">
...
<code>tfc.DeepFactorized(
    batch_shape=(), num_filters=(3, 3), init_scale=10, allow_nan_stats=False,
    dtype=tf.float32, name=&#x27;DeepFactorized&#x27;
)
</code></pre>
...
<td>
Iterable of integers. The desired batch shape for the
...
<td>
Iterable of integers. The number of filters for each of the
...
<td>
Float. Scale factor for the density at initialization. It is
...
<td>
Boolean. Whether to allow `NaN`s to be returned when
...
<td>
A floating point `tf.dtypes.DType`. Computations relating to this
