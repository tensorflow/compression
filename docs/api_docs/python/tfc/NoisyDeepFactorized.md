description: DeepFactorized that is convolved with uniform noise.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tfc.NoisyDeepFactorized" />
...
# tfc.NoisyDeepFactorized

<!-- Insert buttons and diff -->

<table class="tfo-notebook-buttons tfo-api nocontent" align="left">
<td>
  <a target="_blank" href="https://github.com/tensorflow/compression/tree/master/tensorflow_compression/python/distributions/deep_factorized.py#L255-L259">
...
<code>tfc.NoisyDeepFactorized(
    name=&#x27;NoisyDeepFactorized&#x27;, **kwargs
)
</code></pre>
