...
# ==============================================================================
"""Tests of laplace entropy model."""

import numpy as np
import tensorflow as tf
from tensorflow_compression.python.entropy_models.laplace import LaplaceEntropyModel


class LaplaceEntropyModelTest(tf.test.TestCase):

  def test_can_instantiate(self):
    em = LaplaceEntropyModel(coding_rank=1)
  ...
  def test_requires_coding_rank_greater_equal_zero(self):
    with self.assertRaises(ValueError):
      LaplaceEntropyModel(coding_rank=-1)
    ...
    class Compressor:
      ...
      def compress(self, values):
        if not hasattr(self, "em"):
          self.em = LaplaceEntropyModel(coding_rank=1)
